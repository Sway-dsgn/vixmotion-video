...
export const BUILT_IN_EDITING_TEMPLATES: readonly EditingTemplate[] = [
  ...
  },
  {
    ...
    supportedTargets: ["video", "image"],
    controls: [
      { id: "watermarkText", label: "Watermark", type: "text", defaultValue: "@VixMotion" },
  ...
  },
  {
    ...
    supportedTargets: ["video", "image"],
    controls: [
      { id: "tags", label: "Hashtags", type: "text", defaultValue: "#VixMotion #editing #creative" },
    ],
    recipe: {
      effects: [],
      overlays: [
  ...
  },
  {
    ...
    name: "Teal & Orange",
    description: "Hollywood color grading â€” cool shadows, warm highlights.",
    category: "color",
    thumbnailUrl: null,
    previewUrl: null,
