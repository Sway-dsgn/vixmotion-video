...
import { VixMotionMark } from "../brand/VixMotionMark";
...
function formatDimensions(format: NewProjectFormat): string {
  return `${format.width} Ã— ${format.height} Â· ${format.frameRate}fps`;
}
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-10 px-8 py-12">
        <section>
          <div className="flex items-center gap-3">
            <VixMotionMark size={28} className="text-accent" />
