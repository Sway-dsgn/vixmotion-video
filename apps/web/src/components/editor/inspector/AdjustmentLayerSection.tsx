...
import { ToolcraftPopover as Popover } from "@vixmotion/ui";
import { ToolcraftText as Text } from "@vixmotion/ui";
import { PropertySlider } from "./shell/PropertySlider";
import { useEngineStore } from "../../../stores/engine-store";
import { useProjectStore } from "../../../stores/project-store";
import type { AdjustmentLayer, BlendMode, Effect } from "@vixmotion/core";
...
export const AdjustmentLayerSection: React.FC<AdjustmentLayerSectionProps> = ({
  ...
  const [adjustmentLayerEngine, setAdjustmentLayerEngine] =
    useState<import("@vixmotion/core").AdjustmentLayerEngine | null>(null);
  ...
  const persistLayers = useCallback(
    (engine: import("@vixmotion/core").AdjustmentLayerEngine) =>
