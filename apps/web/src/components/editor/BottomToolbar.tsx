...
export const BottomToolbar: React.FC = () => {
  ...
  return (
    <div className="bg-[#0a0a0a] flex flex-col select-none">
      {/* Row 1: Editing Tools */}
      ...
      <div className="h-12 px-4 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-2 relative">
          ...
          >
            {showSceneMenu ? <ChevronUp size={14} /> : <ChevronDown size={14} />}
          </button>
          {showSceneMenu && (
            <>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 rounded-lg hover:bg-white/10 transition-colors text-text-primary min-w-[70px] justify-center"
            >
          ...
          <div
            ...
            className="w-28 h-1.5 bg-bg-2 rounded-full relative mx-2 cursor-ew-resize hover:h-2 transition-all"
          >
            <div
              className="absolute top-1/2 -translate-y-1/2 left-0 bg-accent rounded-full h-full transition-all"
              style={{
                width: `${((pixelsPerSecond - zoomMin) / (zoomMax - zoomMin)) * 100}%`,
              }}
            />
            <div
              ...
              style={{
                left: `calc(${((pixelsPerSecond - zoomMin) / (zoomMax - zoomMin)) * 100}% - 6px)`,
              }}
            />
          </div>
