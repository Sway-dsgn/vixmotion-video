// VixMotion Creation Core - native C++ implementation of the C ABI.
//
...
// in @VixMotion/core/creation. Build with CMake (see CMakeLists.txt); the
// @VixMotion/creation-bindings package loads the resulting library and falls
