...
const STORAGE_KEY = "VixMotion_shortcuts";
const PRESET_KEY = "VixMotion_shortcut_preset";
...
function formatKeyCombo(combo: {
  ...
  const parts: string[] = [];
  if (combo.meta || combo.ctrl) parts.push("âŒ˜");
  if (combo.shift) parts.push("â‡§");
  if (combo.alt) parts.push("âŒ¥");
...
const PRESETS: ShortcutPreset[] = [
  {
    id: "VixMotion",
    name: "VixMotion Default",
    description: "Default VixMotion shortcuts",
    shortcuts: {},
  },
  {
    id: "capcut",
...
class KeyboardShortcutsManager {
  ...
  private activePreset: string = "VixMotion";
