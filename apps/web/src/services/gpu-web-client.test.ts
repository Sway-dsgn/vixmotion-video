...
describe("WebGpuTokenProvider", () => {
  it("mints via challenge then token and caches", async () => {
    ...
    const tp = new WebGpuTokenProvider("https://broker", "com.VixMotion.video", "inst-1");
    ...
    expect(fetchMock.mock.calls[0][1].headers["X-Bundle-ID"]).toBe("com.VixMotion.video");
