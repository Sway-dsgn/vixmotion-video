...
import type { LLMClient } from "@vixmotion/agent";
...
/**
 * Builds an @vixmotion/agent LLMClient whose transport routes through the
 * existing BYOK apiFetch (same-origin Pages proxy in prod, keychain on desktop,
 * direct in dev) â€” keys never leave their existing path.
 */
