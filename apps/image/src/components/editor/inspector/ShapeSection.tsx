...
import { Slider } from '@vixmotion/ui';
import { GradientPicker } from '../../ui/GradientPicker';
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from '@vixmotion/ui';
import { ChevronDown, Link, Unlink } from 'lucide-react';

const DASH_PATTERNS: { value: StrokeDashType; label: string; preview: string }[] = [
  { value: 'solid', label: 'Solid', preview: 'â”â”â”â”â”â”' },
  { value: 'dashed', label: 'Dashed', preview: 'â”€ â”€ â”€ â”€' },
  { value: 'dotted', label: 'Dotted', preview: 'Â· Â· Â· Â· Â·' },
  { value: 'dash-dot', label: 'Dash-Dot', preview: 'â”€ Â· â”€ Â·' },
  { value: 'long-dash', label: 'Long Dash', preview: 'â”€â”€ â”€â”€ â”€â”€' },
];
