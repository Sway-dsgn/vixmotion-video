...
import { ToolcraftLayout as Layout, ToolcraftLayoutContent as LayoutContent } from "@vixmotion/ui";
...
import { createProjectSerializer, createStorageEngine } from "@vixmotion/core";
import type { ValidationResult } from "@vixmotion/core/storage/schema-types";
      ...
      if (importedProject) {
        ...
        if (missingCount > 0) {
          toast.warning(
            ...
            "Go to Assets panel â†’ click \"Relink from Folder\" to restore missing media.",
          );
        }
      }
    } catch (error) {
                  ...
                  {validation.valid && (
                    <Card variant="green" padding={3} className="flex items-center gap-2 border border-primary/30">
                      ...
                      <Text type="body" className="text-primary">
                        Valid project JSON â€” ready to import
                      </Text>
                    </Card>
                  )}
