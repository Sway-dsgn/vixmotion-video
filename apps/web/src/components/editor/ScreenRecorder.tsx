...
import { ToolcraftSwitchControl } from "@vixmotion/ui";
...
const RESOLUTION_OPTIONS: {
  ...
  { value: "720p", label: "720p HD", desc: "1280Ã—720 - Smaller files" },
  { value: "1080p", label: "1080p Full HD", desc: "1920Ã—1080 - Recommended" },
  { value: "1440p", label: "1440p QHD", desc: "2560Ã—1440 - High quality" },
  { value: "4k", label: "4K Ultra HD", desc: "3840Ã—2160 - Maximum quality" },
];
