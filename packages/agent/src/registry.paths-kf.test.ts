...
import type { MotionShapePathPoint } from "@vixmotion/core/motion/motion-shape-path";
import { parseMotionPathSegments } from "@vixmotion/core/motion/motion-shape-path";
