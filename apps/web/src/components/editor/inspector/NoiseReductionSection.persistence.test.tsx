...
import { autoLearnNoiseProfile, type Project } from "@vixmotion/core";
...
vi.mock("@vixmotion/core", async () => {
  const actual = await vi.importActual<typeof import("@vixmotion/core")>("@vixmotion/core");
  return {
    ...actual,
