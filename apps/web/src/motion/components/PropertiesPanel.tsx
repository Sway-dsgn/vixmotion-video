...
import { ToolcraftSwitchControl, ToolcraftText } from "@vixmotion/ui";
import {
  AlignCenter,
              ...
              <Section title="Lighting & Environment" icon={Lightbulb}>
                ...
                <Field label="HDRI map URL" hint=".hdr / .exr / .jpg / .png">
                  <TextInput
                    ...
                    placeholder="https://â€¦/studio_2k.hdr"
                    onChange={(url) =>
                      patchLayer({
                        lighting: {
                          ...selectedLayer.lighting,
              ...
              <div className="flex items-center gap-2 border-b border-border px-3 py-2.5">
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block text-[10.5px] text-fg-muted">
                    {animator.selector.basedOn} Â· {animator.timing.direction}
                  </span>
                </span>
