...
const SpeedCurveCanvas: React.FC<{
  ...
  // â”€â”€ Coordinate helpers (shared by mouse handlers and renderer) â”€â”€
  ...
  const handleMouseUp = useCallback(
    (e: React.MouseEvent<HTMLCanvasElement>) => {
      ...
      if (state.keyframeId) {
        ...
        // Released over empty space â€” add a new keyframe at the
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute bottom-1 right-1 text-[8px] text-fg-3 pointer-events-none">
        Click to add â€¢ Drag to move â€¢ Click a point to remove
      </div>
    </div>
  );
};
