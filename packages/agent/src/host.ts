import type { Action, ActionResult } from "@vixmotion/core/types/actions";
...
export interface EditingHost {
   ...
   * export pipeline that only the live/desktop web host provides â€” headless
   ...
   * live/desktop web host provides â€” headless hosts leave it undefined and the
   ...
   * engine, so it renders nothing â€” this method is the live host's fix.
   */
   ...
   * registers with the GraphicsEngine the preview reads from â€” the raw
