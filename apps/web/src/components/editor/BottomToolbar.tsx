...
export const BottomToolbar: React.FC = () => {
  ...
  return (
    <div className="h-12 bg-[#0a0a0a] border-t border-border flex items-center justify-between px-4">
      {/* Left: Editing Tools */}
      <div className="flex items-center gap-1">
        {tools.map((tool) => (
          ...
          >
            <tool.icon size={18} />
            <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 text-[10px] bg-bg-1 border border-border px-1.5 py-0.5 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
