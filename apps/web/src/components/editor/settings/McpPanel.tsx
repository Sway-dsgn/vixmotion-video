  ...
  return JSON.stringify(
    {
      mcpServers: {
        VixMotion: {
          command: "node",
          args: [shimPath || "<path to VixMotion-mcp shim>"],
        },
      },
    },
    null,
...
export const McpPanel: React.FC = () => {
  ...
  const [status, setStatus] = useState<VixMotionMcpStatus | null>(null);
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <Text type="supporting" color="secondary" className="mt-1 max-w-sm text-xs">
          The MCP server runs inside the VixMotion desktop app, letting external AI
          clients (Claude Desktop, Cursor, Cline) edit your project. Open VixMotion
