...
export const AiTab: React.FC<AiTabProps> = ({
  ...
  // On desktop the local transcription endpoint (cloud.VixMotion.video) is
  // CORS-blocked from app://VixMotion, so generation is done via the GPU
            ...
            <div className="space-y-3">
              ...
              {isDesktop && (
                <Text type="supporting" color="secondary" className="text-[11px]">
                  Use the â€œAuto Captionsâ€ tool in Cloud GPU Tools above to generate captions.
                </Text>
              )}
              {!isDesktop && (
                <>
