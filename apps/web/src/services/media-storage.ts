import { StorageEngine } from "@vixmotion/core";
import type { MediaRecord, MediaMetadata } from "@vixmotion/core";
...
export async function clearAllStorage(): Promise<void> {
  ...
  const databasesToDelete = ["vixmotion-autosave", "vixmotion-projects", "vixmotion-templates"];
