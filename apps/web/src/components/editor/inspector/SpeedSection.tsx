...
import type { Clip } from "@vixmotion/core";
import { getSpeedEngine } from "@vixmotion/core";
...
const SPEED_PRESETS = [
  { label: "0.25Ã—", value: 0.25 },
  { label: "0.5Ã—", value: 0.5 },
  { label: "0.75Ã—", value: 0.75 },
  { label: "1Ã—", value: 1 },
  { label: "1.25Ã—", value: 1.25 },
  { label: "1.5Ã—", value: 1.5 },
  { label: "2Ã—", value: 2 },
  { label: "3Ã—", value: 3 },
  { label: "5Ã—", value: 5 },
];
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        ...
        <Text type="supporting" color="secondary" className="text-xs">
          Range: 0.1Ã— (slowest) to 100Ã— (fastest)
        </Text>
      </div>
      ...
      {(currentSpeed !== 1 || isReversed) && (
        <Card variant="muted" padding={3} className="border border-border">
          ...
          <Text type="body" color="primary" className="block text-sm">
            Speed: {currentSpeed}Ã— {isReversed && "â€¢ Reversed"}
            {clip.smoothSlowMo && " â€¢ Smooth"}
          </Text>
        </Card>
      )}
    </div>
