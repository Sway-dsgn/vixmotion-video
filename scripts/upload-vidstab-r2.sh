...
# Bucket: pub-VixMotion (or your bucket name)
# Path prefix: ffmpeg-vidstab/

BUCKET="pub-VixMotion"
...
echo "  https://pub-VixMotion.r2.dev/ffmpeg-vidstab/mt/"
echo "  https://pub-VixMotion.r2.dev/ffmpeg-vidstab/st/"
