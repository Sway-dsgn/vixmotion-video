import { ActionExecutor } from "@vixmotion/core/actions/action-executor";
import { ActionHistory } from "@vixmotion/core/actions/action-history";
...
export class HeadlessHost implements EditingHost {
  ...
  beginTransaction(label?: string): TxnHandle {
    ...
    // discarding entries mid-turn â€” both of which can defeat inverse-replay.
