    ...
    <div className="h-full w-full bg-background flex flex-col">
      <header className="flex items-center justify-between px-8 py-6 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">VixMotion Image</h1>
          ...
          {showCustomSize && (
            <section className="mb-10 p-6 rounded-xl bg-card border border-border">
              ...
              <div className="flex items-end gap-4">
                ...
                <span className="text-muted-foreground pb-2.5">Ã—</span>
                <div>
                ...
                {recentProjects.map((project) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground/70 mt-1">
                      {project.size.width} Ã— {project.size.height}
                    </p>
                  </div>
                ))}
              </div>
      ...
      <footer className="px-8 py-4 border-t border-border flex items-center justify-between">
        <p className="text-xs text-muted-foreground">
          VixMotion Image â€” Professional graphic design in your browser
        </p>
        <p className="text-xs text-muted-foreground">
