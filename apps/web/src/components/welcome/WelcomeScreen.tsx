...
import { SOCIAL_MEDIA_PRESETS, type SocialMediaCategory } from "@vixmotion/core";
...
const VixMotionLogo: React.FC<{ className?: string }> = ({ className = "" }) => (
  <img src={logoWithText} alt="VixMotion" className={className} />
);
          ...
          <div className="flex flex-col items-center text-center mb-12">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 text-primary">
                <VixMotionLogo className="w-full h-full" />
              </div>
