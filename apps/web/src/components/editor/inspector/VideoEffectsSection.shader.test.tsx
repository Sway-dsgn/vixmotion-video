...
import type { Project } from "@vixmotion/core";
import { getMotionShaderDef, getMotionShaderEffectDefs } from "@vixmotion/core";
  ...
  it("opens a searchable visual picker for standard and shader effects", () => {
    ...
    fireEvent.click(
      screen.getByRole("button", {
        name: `Shaders Â· ${getMotionShaderEffectDefs().length}`,
      }),
    );
    expect(
      screen.getByRole("button", {
