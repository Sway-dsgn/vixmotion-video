import type { Project, ProjectSettings } from "@vixmotion/core";
import { normalizeProjectStoredFields } from "@vixmotion/core";
...
const PROJECT_DB_NAME = "vixmotion-projects";
