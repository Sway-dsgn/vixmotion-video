...
const out = path.join(tmpdir(), `VixMotion-export-${stamp}.mp4`);
const wav = path.join(tmpdir(), `VixMotion-export-${stamp}.wav`);
const proresOut = path.join(tmpdir(), `VixMotion-export-prores-${stamp}.mov`);
const proresWav = path.join(tmpdir(), `VixMotion-export-prores-${stamp}.wav`);
const hiResOut = path.join(tmpdir(), `VixMotion-export-hires-${stamp}.mp4`);
const hiResWav = path.join(tmpdir(), `VixMotion-export-hires-${stamp}.wav`);
