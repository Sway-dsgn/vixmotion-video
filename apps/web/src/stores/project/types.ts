...
import { ActionExecutor, ActionHistory } from "@vixmotion/core";
import type {
  VideoEffect,
  VideoEffectType,
...
export interface ClipHistoryEntry {
  ...
  /**
   * "create" (default when omitted) â€” undo deletes the clip from its engine,
   * redo recreates it. "update" â€” a property edit; undo restores `clipData`
