...
export interface ProjectState {
  ...
  updateClipBlendMode: (
    clipId: string,
    blendMode: import("@vixmotion/core").BlendMode,
  ) => Promise<ActionResult>;
  ...
  updateClipEmphasisAnimation: (
    clipId: string,
    emphasisAnimation: import("@vixmotion/core").EmphasisAnimation,
  ) => Promise<ActionResult>;
  ...
  updateText3D: (
    clipId: string,
    text3d: import("@vixmotion/core").Text3DSettings | undefined,
  ) => TextClip | null;
  ...
  addSubtitle: (subtitle: import("@vixmotion/core").Subtitle) => Promise<void>;
  removeSubtitle: (subtitleId: string) => void;
  updateSubtitle: (
    subtitleId: string,
    updates: Partial<import("@vixmotion/core").Subtitle>,
  ) => void;
  getSubtitle: (
    subtitleId: string,
  ) => import("@vixmotion/core").Subtitle | undefined;
  importSRT: (
    srtContent: string
  ...
  updateMarker: (
    markerId: string,
    updates: Partial<import("@vixmotion/core").Marker>,
  ) => Promise<ActionResult>;
  getMarker: (markerId: string) => import("@vixmotion/core").Marker | undefined;
  getMarkers: () => import("@vixmotion/core").Marker[];
  ...
  updateSVGClip: (
    ...
    updates: {
      ...
      duration?: number;
      transform?: Partial<Transform>;
      entryAnimation?: import("@vixmotion/core").GraphicAnimation;
      exitAnimation?: import("@vixmotion/core").GraphicAnimation;
      colorStyle?: import("@vixmotion/core").SVGColorStyle;
    },
  ) => SVGClip | null;
...
export const useProjectStore = create<ProjectState>()(
  subscribeWithSelector((set, get) => {
    ...
    // of text/shape property edits). Never creates or deletes the clip â€” it
