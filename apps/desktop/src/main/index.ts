...
// Drop regenerable GPU/shader/code caches when the app version changes â€” before
// app is ready and the GPU process starts â€” so an upgrade can't crash on a stale
...
const BROKER_BASE_URL =
  process.env.VIXMOTION_AUTH_BROKER_BASE_URL ?? "https://api.VixMotion.video";
const GPU_BASE_URL = process.env.VIXMOTION_GPU_BASE_URL ?? "https://ai.VixMotion.video";
const GPU_BUNDLE_ID = "com.VixMotion.video";
