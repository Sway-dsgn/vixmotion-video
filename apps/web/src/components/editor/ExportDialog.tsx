...
import { ToolcraftSegmentedControl, ToolcraftSwitchControl } from "@vixmotion/ui";
import { ToolcraftButton as Button } from "@vixmotion/ui";
import { ToolcraftDialog as Dialog, ToolcraftDialogHeader as DialogHeader } from "@vixmotion/ui";
import { ToolcraftLayout as Layout, ToolcraftLayoutContent as LayoutContent, ToolcraftLayoutFooter as LayoutFooter } from "@vixmotion/ui";
import { ToolcraftNumberInputControl } from "@vixmotion/ui";
...
import { ToolcraftSliderControl } from "@vixmotion/ui";
...
const WEB_EXPORT_GUARDRAIL_MESSAGE =
  "Web export can't produce ProRes or alpha â€” this will encode H.264 without transparency. Use the desktop app for ProRes/alpha.";
              ...
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="text-sm font-semibold text-text-primary">
                    Quick Export â€” Match Source
                  </div>
                  <div className="text-[11px] text-text-muted truncate">
                    {sourceMatch.width}Ã—{sourceMatch.height}
                    {sourceMatch.frameRate ? ` â€¢ ${sourceMatch.frameRate}fps` : ""} â€¢ MP4 Â· matches â€œ{sourceMatch.sourceName}â€
                  </div>
                </div>
              </div>
                ...
                <div className="rounded-lg border border-border bg-background-tertiary/40 p-4 space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-semibold text-text-primary">
                      {reducePlan.width}Ã—{reducePlan.height} Â· ~
                  ...
                  <div className="flex items-center justify-between text-[11px]">
                    <span className="text-text-muted">
                      ...
                      {reducePlan.audioBitrateKbps > 0
                        ? ` Â· ${reducePlan.audioBitrateKbps} kbps audio`
                        : ""}{" "}
                      Â· {reducePlan.frameRate}fps
                    </span>
                    {reduceSavingsPercent > 0 && (
                      <span className="font-bold text-primary">
                        âˆ’{reduceSavingsPercent}% vs source
                      </span>
                    )}
                  </div>
                </div>
