...
import { DEFAULT_MOTION_TRANSFORM } from "@vixmotion/core/motion/types";
import type {
  MotionComposition,
  MotionLayer,
  MotionShapeLayer,
} from "@vixmotion/core/motion/types";
import type {
  EditingHost,
...
describe("render queue MCP tools â€” registration", () => {
...
describe("render queue MCP tools â€” headless graceful failure", () => {
...
describe("queue_motion_render â€” validation", () => {
...
describe("render queue MCP tools â€” round-trip", () => {
