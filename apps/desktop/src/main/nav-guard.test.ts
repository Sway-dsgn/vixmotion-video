...
const APP_INDEX = "app://VixMotion/index.html";

describe("isAllowedNavigation", () => {
  it("allows same-origin app navigation", () => {
    expect(isAllowedNavigation("app://VixMotion/editor", APP_INDEX)).toBe(true);
    expect(isAllowedNavigation("app://VixMotion/index.html#x", APP_INDEX)).toBe(true);
  });
