# VixMotion rigging sidecars

This folder is the desktop app's optional rigging backend resource root.

In development, VixMotion checks this folder first after environment overrides:

- `VixMotion_BLENDER_PATH=/absolute/path/to/blender`
