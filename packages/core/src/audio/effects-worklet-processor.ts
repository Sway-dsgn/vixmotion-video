export const EFFECTS_WORKLET_NAME = "VixMotion-effects-processor";
...
class VixMotionEffectsProcessor extends AudioWorkletProcessor {
 constructor(options) {
 super();
...
registerProcessor('${EFFECTS_WORKLET_NAME}', VixMotionEffectsProcessor);
`;
