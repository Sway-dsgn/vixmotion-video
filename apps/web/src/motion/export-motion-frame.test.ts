...
import type { MotionComposition, Project } from "@vixmotion/core";
import {
...
vi.mock("@vixmotion/core/creation/index", () => ({
...
describe("motion frame export helpers", () => {
  beforeEach(() => {
    ...
    Object.defineProperty(window, "VixMotion", {
      configurable: true,
      value: undefined,
    });
    delete (window as { __VixMotionExportPath?: string }).__VixMotionExportPath;
  ...
  it("exports compatible creation-backed scene3d compositions through native Aurora", async () => {
    ...
    expect((window as { __VixMotionExportPath?: string }).__VixMotionExportPath).toBe(
