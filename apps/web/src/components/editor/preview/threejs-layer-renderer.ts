...
import type { BlendMode } from "@vixmotion/core";

// â”€â”€â”€ 3D text font cache â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export function get3DFont(
  ...
  if (!FONT_LOADING.has(url)) {
    ...
    promise.catch(() => {
      /* font load failure is non-fatal â€” we fall back to 2D */
    });
  }
  return undefined;
}
...
export class ThreeJSLayerRenderer {
  ...
  renderTextClip(
    ...
    // 3D extrusion path â€” only when explicitly enabled AND the font
  ...
  private buildShape3DMesh(
    ...
    // so 2D â†” 3D toggles don't surprise the user with size jumps.
